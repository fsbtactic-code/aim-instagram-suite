...
export interface ViralSlideTemplate {
  position: number;
  role: string;           // Роль слайда в воронке
  trigger: string;        // Психологический триггер
  titleFormula: string;   // Формула заголовка
  bodyFormula: string;    // Формула тела текста
  emoji: string;
  cta?: string;           // Призыв (только для финала)
}
...
// ─────────────────────────────────────────────────────────────────────────────
const openLoopStructure: ViralStructure = {
  id: 'open-loop',
...
// ─────────────────────────────────────────────────────────────────────────────
const listicleStructure: ViralStructure = {
  id: 'listicle',
...
// ─────────────────────────────────────────────────────────────────────────────
const beforeAfterStructure: ViralStructure = {
  id: 'before-after',
...
// ─────────────────────────────────────────────────────────────────────────────
const mythBustingStructure: ViralStructure = {
  id: 'myth-busting',
...
// ─────────────────────────────────────────────────────────────────────────────
const stepByStepStructure: ViralStructure = {
  id: 'step-by-step',
...
// ─────────────────────────────────────────────────────────────────────────────
const caseStudyStructure: ViralStructure = {
  id: 'case-study',
...
// ─────────────────────────────────────────────────────────────────────────────
const hotTakeStructure: ViralStructure = {
  id: 'hot-take',
...
// ─────────────────────────────────────────────────────────────────────────────
const checklistAuditStructure: ViralStructure = {
  id: 'checklist-audit',
...
// ─────────────────────────────────────────────────────────────────────────────
const avsBStructure: ViralStructure = {
  id: 'a-vs-b',
...
// ─────────────────────────────────────────────────────────────────────────────
const dayInLifeStructure: ViralStructure = {
  id: 'day-in-life',
...
// ─────────────────────────────────────────────────────────────────────────────
const faqStructure: ViralStructure = {
  id: 'faq',
...
// ─────────────────────────────────────────────────────────────────────────────
const storyArcStructure: ViralStructure = {
  id: 'story-arc',
...
export function getViralStructure(id: string): ViralStructure | undefined {
  return VIRAL_STRUCTURES[id];
}

export function listViralStructures(): ViralStructure[] {
  return Object.values(VIRAL_STRUCTURES);
}

/**
 * Генерирует шаблонный JSON слайдов из вирусной структуры
 */
export function structureToSlides(structure: ViralStructure): Array<{
  slideNumber: number;
  title: string;
  subtitle: string;
  body: string;
