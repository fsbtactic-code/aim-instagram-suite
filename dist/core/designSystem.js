...
exports.generateBrandColorOverlay = generateBrandColorOverlay;
exports.listAvailableFonts = listAvailableFonts;
// ─────────────────────────────────────────────────────────────────────────────
...
function getTheme(id) {
    ...
    if (!t)
        throw new Error(`Unknown theme id: ${id}. Valid: 1-12`);
    return t;
}
...
`;
function resolveThemeCSS(theme, customCss) {
    return theme.css + '\n' + READABILITY_BOOST + (customCss ? '\n' + customCss : '');
}
// ─────────────────────────────────────────────────────────────────────────────
// BRAND COLOR OVERLAY  (used by aim_auto_brand_colors)
// ─────────────────────────────────────────────────────────────────────────────
function generateBrandColorOverlay(primary, secondary, text = '#FFFFFF') {
    return `
    /* ── Brand Color Overlay ── */
