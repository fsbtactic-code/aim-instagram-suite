...
exports.LAYOUTS_CSS = void 0;
exports.buildCtaBanner = buildCtaBanner;
exports.buildSlideCounter = buildSlideCounter;
exports.buildSlideFooter = buildSlideFooter;
exports.renderStandard = renderStandard;
exports.renderHeroNumber = renderHeroNumber;
exports.renderGrid2x2 = renderGrid2x2;
exports.renderGoodBad = renderGoodBad;
exports.renderBeforeAfter = renderBeforeAfter;
exports.renderSteps3 = renderSteps3;
exports.renderQuote = renderQuote;
exports.renderChecklist = renderChecklist;
exports.renderComparison = renderComparison;
exports.renderCtaFinal = renderCtaFinal;
exports.renderSlideLayout = renderSlideLayout;
// ── Premium CTA баннер (legacy, for layouts that use it inline) ───────────────
function buildCtaBanner(ctaText) {
    if (!ctaText)
        return '';
    return `
...
function buildSlideCounter(num, total) {
...
function buildSlideFooter(num, total, ctaText) {
    const n = String(num).padStart(2, '0');
    const t = String(total).padStart(2, '0');
...
// ── ЛЕЙАУТ 1: Standard ────────────────────────────────────────────────────────
function renderStandard(slide, total) {
...
function renderHeroNumber(slide, total) {
...
// ── ЛЕЙАУТ 3: Grid 2×2 ───────────────────────────────────────────────────────
function renderGrid2x2(slide, total) {
...
// ── ЛЕЙАУТ 4: Good / Bad ─────────────────────────────────────────────────────
function renderGoodBad(slide, total) {
...
function renderBeforeAfter(slide, total) {
    const { title, blocks = [], leftBlocks, rightBlocks, ctaText } = slide;
    let beforeText = '';
    let afterText = '';
    if (leftBlocks && leftBlocks.length > 0) {
...
// ── ЛЕЙАУТ 6: Steps-3 ────────────────────────────────────────────────────────
function renderSteps3(slide, total) {
    const { title, blocks = [], ctaText } = slide;
...
// ── ЛЕЙАУТ 7: Quote ──────────────────────────────────────────────────────────
function renderQuote(slide, total) {
...
// ── ЛЕЙАУТ 8: Checklist ───────────────────────────────────────────────────────
function renderChecklist(slide, total) {
...
// ── ЛЕЙАУТ 9: Comparison ─────────────────────────────────────────────────────
function renderComparison(slide, total) {
    ...
    if (maxRows === 0)
        maxRows = 3; // Fallback to 3 empty rows if no data provided
...
// ── ЛЕЙАУТ 10: CTA Final ─────────────────────────────────────────────────────
function renderCtaFinal(slide, total) {
...
// ── Диспетчер лейаутов ────────────────────────────────────────────────────────
function renderSlideLayout(slide, total = 1) {
